...
class TestFieldSearchEngine:
    ...
    def test_search_engine_creation(self):
        ...
        # Mock field data
        fields = {
            "pe_ratio": FieldMetadata(
                "pe_ratio", "P/E Ratio", "valuation", "Price to earnings", "float"
            ),
            "eps_growth_qtr": FieldMetadata(
                "eps_growth_qtr",
                "EPS Growth QoQ",
                "growth",
    ...
    def test_search_by_keyword(self):
        ...
        fields = {
            "pe_ratio": FieldMetadata(
                "pe_ratio", "P/E Ratio", "valuation", "Price to earnings ratio", "float"
            ),
            "pb_ratio": FieldMetadata(
                "pb_ratio", "P/B Ratio", "valuation", "Price to book ratio", "float"
            ),
            "eps_growth_qtr": FieldMetadata(
                "eps_growth_qtr",
                "EPS Growth",
    ...
    def test_search_case_insensitive(self):
        ...
        fields = {
            "pe_ratio": FieldMetadata(
                "pe_ratio", "P/E Ratio", "valuation", "Price Earnings ratio", "float"
            )
        }
    ...
    def test_search_with_category_filter(self):
        ...
        fields = {
            "pe_ratio": FieldMetadata(
                "pe_ratio", "P/E Ratio", "valuation", "Price ratio", "float"
            ),
            "current_ratio": FieldMetadata(
                "current_ratio",
                "Current Ratio",
                "fundamental",
                "Liquidity ratio",
            ...
            "performance_year": FieldMetadata(
                "performance_year",
                "1Y Performance",
                "performance",
                "Annual return",
    ...
    def test_search_no_results(self):
        ...
        fields = {
            "pe_ratio": FieldMetadata(
                "pe_ratio", "P/E Ratio", "valuation", "Price earnings", "float"
            )
        }
    ...
    def test_search_ranking(self):
        ...
        fields = {
            ...
            "sales_growth_qtr": FieldMetadata(
                "sales_growth_qtr",
                "Sales Growth",
                "growth",
