    ...
    try:
        ...
        try:
            filings = client.get_company_filings(
                ticker="AAPL", form_types=["10-K", "10-Q"], max_count=5
            )
        ...
        if "filings" in locals() and filings:
            ...
            try:
                ...
                if content.get("status") == "success":
                    ...
                    print(
                        f"   📝 Document content retrieved: {content_length} characters"
                    )
                    print("   ✅ Document content retrieval successful")
                else:
                    print(
                        f"   ⚠️ Document content retrieval failed: {content.get('error', 'Unknown error')}"
                    )
